...
garden-path corpus. The sections below establish that result on the Natural
Stories corpus, apply the same specification to the garden-path materials, and
...
the garden-path corpus. Nuisance controls (previous reading time, sentence
position and its quadratic terms) are included in every model but omitted from
the plot; word length is likewise omitted, being large enough in the garden-path
